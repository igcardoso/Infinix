...
*/
      ...
      db.collection('affairs').onSnapshot((data)=> {
        ...
        data.docs.map(doc => {
          ...
          <li style="opacity:var(--${doc.data().indexing_files});" onclick="window.location = '${doc.data().indexing_files}'">Arquivos</li>
          <li style="opacity:var(--${doc.data().description});" >${doc.data().description}</li>
          <li style="opacity:var(--${doc.data().photograph});" onclick="window.location = '${doc.data().photograph}'" ><img src="${doc.data().photograph}"/></li>
