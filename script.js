...
*/
        ...
        data.docs.map(doc => {
          ...
          highlights.addEventListener("click",
            function() {
              ...
              document.querySelector("main .home .highlights").style.display = "block"
              document.querySelector("main .home .back").addEventListener("click", function() {
                ...
                document.querySelector("main .highlights").style.display = "none"
      ...
      db.collection('affairs').onSnapshot((data)=> {
        ...
        data.docs.map(doc => {
          ...
          <li>${doc.data().name}</li>
          <li>${doc.data().date}</li>
          <li onclick="document.querySelector('#infoOptions').style.display = 'block'" onclose="document.querySelector('#infoOptions2').style.display = 'block'" class="plus"><i class="bx bx-plus"></i>
          </li>
          <ul id="infoOptions">
      ...
      db.collection('evaluation').onSnapshot((data)=> {
        ...
        data.docs.map(doc => {
          ...
          <li>${doc.data().name}</li>
          <li>${doc.data().date}</li>
          <li onclick="document.querySelector('#infoOptions2').style.display = 'block'" onclose="document.querySelector('#infoOptions2').style.display = 'block'" class="plus"><i class="bx bx-plus"></i>
          </li>
          <ul id="infoOptions2">
          <li onclick="window.location = '${doc.data().indexing_files}'">Arquivos</li>
          <li>${doc.data().description}</li>
